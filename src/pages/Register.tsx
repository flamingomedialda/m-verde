              ...
              {([
                ...
                return (
                  <button
                    ...
                    type="button"
                    onClick={() => setGender(v)}
                    className={`flex flex-col items-center gap-1 py-3 rounded-2xl border-2 tap-scale transition-all ${
                      sel ? "border-primary bg-accent text-primary" : "border-transparent bg-muted text-muted-foreground"
                    }`}
                  >
